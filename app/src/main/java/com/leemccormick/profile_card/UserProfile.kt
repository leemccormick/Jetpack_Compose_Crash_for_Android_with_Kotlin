package com.leemccormick.profile_card

data class UserProfile(val id: Int, val name: String, val status: Boolean, val photoUrl: String)

/*
val userProfileList = arrayListOf<UserProfile>(
    UserProfile(name = "John Doe", status = true, R.drawable.profile_picture),
    UserProfile(name = "Anna Joan", status = false, R.drawable.profile_picture2),
    UserProfile(name = "John Doe", status = true, R.drawable.profile_picture),
    UserProfile(name = "Anna Joan", status = false, R.drawable.profile_picture2),
    UserProfile(name = "John Doe", status = true, R.drawable.profile_picture),
    UserProfile(name = "Anna Joan", status = false, R.drawable.profile_picture2),
